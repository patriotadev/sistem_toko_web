...
import { IBarangPenjualan, IPenjualan } from "../../../modules/penjualan/interfaces/penjualan.interface"
...
export type InvoicePenjualanOptionType = {
  label: string
  value: string
  detail: IInvoicePenjualan
}
